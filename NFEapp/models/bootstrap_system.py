...
def bootstrap_system():
    ...
    system.create_open_course(system.getUNSWMember('admin_1'), "Free lunch hour concert May - Australia Ensemble",'open','2018-05-27','13:10','John Niland Scientia Building',20,'2018-05-26', 15, '2018-05-26',
    ...
    system.create_open_course(staff1, "Economic Inequality: From Wisconsin to Whyalla",'open','2018-05-29','10:00','Carriageworks',15,'2018-05-29', 40, '2018-05-28',
    ...
    'Lesson 1', 'open', '2018-06-30', '17:00', 'Mathews Theatre A', 5, '2018-05-19', 20, '2018-05-19', 'Python', 'Isaac Carr', 'i.carr@unsw.edu.au')
    ...
    system.add_session(staff3, seminar1, 'Public Enforcement Reputation and the Dual Role of Investor Litigation', 'open','2018-05-21', '09:00', 'Room 2063, Quadrangle Building', 7, '2018-05-19', 10, '2018-05-18','How to Succeed in Business Without Really Trying', 'Boy 1', 'boy1@unsw.edu.au')
