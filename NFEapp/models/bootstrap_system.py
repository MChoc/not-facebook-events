...
def bootstrap_system():
    ...
    system.create_open_course(system.getUNSWMember('admin_1'), "Conversation with Jenny Zhang", 'open', '2018-05-25', '18:15', "CLB7", 15, '2018-05-23', 30, '2018-05-20',
    ...
    system.create_open_course(system.getUNSWMember('admin_1'), "Free lunch hour concert May - Australia Ensemble",'open','2018-05-17','13:10','John Niland Scientia Building',20,'2018-05-16', 15, '2018-05-16',
    ...
    system.create_open_seminar(system.getUNSWMember('admin_1'), 'New College presents: How to Succeed in Business Without Really Trying', 'open', "In the early 1960s, young window-cleaner, J. Pierrepont Finch discovers a book with instructions on how to climb to the top of the company ladder. But it's not long before Finch’s unorthodox and morally questionable business practices jeopardize not only his career but also his flowering romance with Secretary Rosemary Pilkington. New College productions are known for their particularly entertaining atmosphere and high production quality, so please come along!", 'Session 1', 'open', '2018-05-23', '21:30', 'New College, UNSW', 5, '2018-05-22', 20, '2018-05-20','Opening night', Speaker('Boy 1', 'boy1@unsw.edu.au'))
    system.add_session(system.getUNSWMember('admin_1'), system.getOpenEvent('New College presents: How to Succeed in Business Without Really Trying'), 'Session 2', 'open', '2018-05-24', '21:30', 'New College, UNSW', 5, '2018-05-23', 10, '2018-05-20', 'Middle night', Speaker('Boy 2', 'boy2@unsw.edu.au'))
    system.add_session(system.getUNSWMember('admin_1'), system.getOpenEvent('New College presents: How to Succeed in Business Without Really Trying'), 'Session 3', 'open', '2018-05-25', '21:30', 'New College, UNSW', 5, '2018-05-24', 10, '2018-05-20', 'Closing night', Speaker('Boy 3', 'boy3@unsw.edu.au'))

    staff1 = system.getUNSWMember('name4119998')
    staff2 = system.getUNSWMember('name4119997')
    staff3 = system.getUNSWMember('name4119995')
    system.create_open_course(staff1, "Economic Inequality: From Wisconsin to Whyalla",'open','2018-05-20','10:00','Carriageworks',15,'2018-05-19', 40, '2018-05-18',
    ...
    'Lesson 1', 'open', '2018-06-03', '17:00', 'Mathews Theatre A', 5, '2018-06-02', 20, '2018-05-30', 'Python', Speaker('Isaac Carr', 'i.carr@unsw.edu.au'))
    ...
    'Lesson 1', 'open', '2018-05-24', '17:00', 'Sir John Clancy Auditorium', 5, '2018-05-19', 20, '2018-05-22', 'Water Cycle', Speaker('Seokhyeon Kim', 'seokhyeon.kim@unsw.edu.au'))

    system.create_open_seminar(staff3, 'Effect of CSR Information Presentation Order on Stakeholder Decision‐Making', 'open', 'Stakeholder demand for information about broader social and environmental dimensions of organizational performance is growing', 'Corporate Social Responsibility', 'open', '2018-05-19','16:00', 'Tyree Energy Technology LG07', 15, '2018-05-18', 30, '2018-05-16', 'Socially responsible investment strategies', Speaker('Jaze', 'jaze@gmail.com'))
    seminar1 = system.getOpenEvent('Effect of CSR Information Presentation Order on Stakeholder Decision‐Making')
    system.add_session(staff3, seminar1, 'Public Enforcement Reputation and the Dual Role of Investor Litigation', 'open','2018-05-21', '09:00', 'Room 2063, Quadrangle Building', 7, '2018-05-19', 10, '2018-05-18','How to Succeed in Business Without Really Trying', Speaker('John Zaitseff', 'j.zaitseff@unsw.edu.au'))
    system.add_session(staff3, seminar1, 'On the efficient level of inequality in business income', 'closed', '2018-05-27', '10:00', '232, UNSW Business School building', 10, '2018-05-24', 10, '2018-05-23', 'Does External Monitoring Affect the Performance of State-Owned Enterprises?', Speaker('Thomas', 'thomas@gmail.com'))
