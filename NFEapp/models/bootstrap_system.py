...
def bootstrap_system():
    ...
    system.add_session(system.getUNSWMember('admin_1'), system.getOpenEvent('New College presents: How to Succeed in Business Without Really Trying'), 'Session 2', 'open', '2018-05-04', '21:30', 'New College, UNSW', 5, '2018-05-03', 'Middle night', Speaker('Boy 2', 'boy2@unsw.edu.au'))
    system.add_session(system.getUNSWMember('admin_1'), system.getOpenEvent('New College presents: How to Succeed in Business Without Really Trying'), 'Session 3', 'open', '2018-05-05', '21:30', 'New College, UNSW', 5, '2018-05-04', 'Closing night', Speaker('Boy 3', 'boy3@unsw.edu.au'))
