...
def bootstrap_system():
    ...
    system.create_open_seminar(staff3, 'Effect of CSR Information Presentation Order on Stakeholder Decision‐Making', 'open', 'Stakeholder demand for information about broader social and environmental dimensions of organizational performance is growing', 'Corporate Social Responsibility', 'open', '2018-05-25','16:00', 'Tyree Energy Technology LG07', 15, '2018-05-18', 30, '2018-05-16', 'Socially responsible investment strategies', 'Jaze Zhang', 'zhangting@gmail.com')
    ...
    system.add_session(staff3, seminar1, 'On the efficient level of inequality in business income', 'open', '2018-05-20', '10:00', '232, UNSW Business School building', 10, '2018-05-15', 10, '2018-05-23', 'Does External Monitoring Affect the Performance of State-Owned Enterprises?', 'Thomas', 'thomas@gmail.com')
